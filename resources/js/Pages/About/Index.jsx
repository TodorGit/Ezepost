                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div className="p-6 text-gray-900">
                            <div className="2xl:mx-auto 2xl:container 2xl:px-20 px-6 ">
                                <div
                                    className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
                                    <div
                                        className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                                        <div className="flex flex-col items-center justify-center">
                                            <h1 className="md:text-5xl text-3xl font-bold text-center text-gray-800">Secure
                                                File Transfer for the Digital Age</h1>
                                            <p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600">At
                                                Group 3 Technology, we specialize in providing robust solutions for
                                                secure file transfer over the Internet. Catering to both individuals and
                                                organizations, we prioritize the safety and integrity of your data.</p>
                                            <div className="md:mt-14 mt-12 flex flex-col items-center">
                                                ...
                                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full"> Engineered
                                                    with Electron and Angular, EZE POST offers a user-friendly interface
                                                    while utilizing UDP ports for reliable and encrypted file transfers.
                                                    Our unique approach ensures that files are split into encrypted
                                                    chunks, which remain unchanged during transit, safeguarding the data
                                                    until the intended recipient decides to access it.</p>
                                            </div>
                                            <div className="mt-7 flex flex-col items-center">
                                                ...
                                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">Client
                                                    data is critical, and we treat it with the utmost respect. While our
                                                    desktop app collects essential data for service enhancement, our
                                                    website serves as a portal for users to manage their accounts and
                                                    subscriptions. We aim to provide best customer service.</p>
                                            </div>
                                            <div className="mt-7 flex flex-col items-center">
                                                <div
                                                    className="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center"
                                                    role="img" aria-label="ideas">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#4338CA" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"/>
                                                        <path d="M14.667 5.33331H22.667" stroke="#4338CA"
                                                              stroke-width="1.5" stroke-linecap="round"
                                                              stroke-linejoin="round"/>
                                                        <path d="M18.667 1.33331V9.33331" stroke="#4338CA"
                                                              stroke-width="1.5" stroke-linecap="round"
                                                              stroke-linejoin="round"/>
                                                    </svg>
                                                </div>
                                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">Payment
                                                    Processing: Client payment details are securely stored on Stripe
                                                    servers, ensuring industry-leading protection for your financial
                                                    information.
                                                </p>
                                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full"> Customer
                                                    Portal: Directly access your account details through the
                                                    EZE POST website, where managing your subscriptions and usage is
                                            ...
                                            <div className="mt-7 flex flex-col items-center">
                                                <div
                                                    className="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center"
                                                    role="img" aria-label="bright ideas">
                                                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke-linejoin="round"
                                                        />
                                                        <path d="M9.93359 19.6666H16.0669" stroke="#4338CA"
                                                              stroke-width="1.5" stroke-linecap="round"
                                                              stroke-linejoin="round"/>
                                                    </svg>
                                                </div>
                                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">We
                                                    understand the paramount importance of data security. EZE POST's
                                                    encryption protocols are designed to protect your information,
                                                    providing peace of mind with every file you send.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="py-12 xl:w-1/2 lg:w-1/3 sm:w-1/2">
                                        <img src="https://i.ibb.co/7SmJNvH/about-image.png"
